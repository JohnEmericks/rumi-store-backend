...
/**
 * Build the system prompt - simple and clean
 */
...
## VAD BUTIKEN SÄLJER
${storeProductSummary || "Våra produkter"}
...
- Om kunden ber att få se något, visa det direkt
...
${storeProductSummary || "Our products"}
...
- If the customer asks to see something, show it directly
...
function buildContextMessage(products, pages, language = "Swedish") {
  ...
  if (products.length > 0) {
    parts.push(sv ? "## RELEVANTA PRODUKTER" : "## RELEVANT PRODUCTS");
